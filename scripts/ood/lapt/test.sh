...
do
    ...
    do
        CUDA_VISIBLE_DEVICES=1 python main.py \
            ...
            --network.checkpoint /data1/wenjie/projects/OpenOOD-VLM/debug_oodval_dedup_scratch_nctx2/imagenet_coop_negoodprompt_oodmixup_idood_sgd_e10_lr0.01_alpha1_beta0_wccm_ood1000_w1-1-1-1_multice_sgdlr0.01_wd0.00001/s0/best.ckpt \
